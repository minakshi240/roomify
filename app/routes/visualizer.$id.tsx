    ...
    const runGeneration = async (item: DesignItem) => {
        ...
        try {
            ...
            if(!result.renderedImage) {
                throw new Error('The AI service returned no rendered image.');
            }
            ...
            if(!saved) {
                throw new Error('The render was created but could not be saved. Configure VITE_PUTER_WORKER_URL and try again.');
            }
    ...
    useEffect(() => {
        ...
        const loadProject = async () => {
            ...
            const fallbackProject = locationState?.initialImage ? {
                ...
                renderedImage: locationState.initialRender,
                timestamp: Date.now(),
            } : null;
                ...
                <div className="panel">
                    ...
                    <div className={`render-area ${isProcessing ? 'is-processing': ''}`}>
                        ...
                        {generationError && !isProcessing && (
                            <div className="render-error" role="alert">{generationError}</div>
                        )}
                    </div>
